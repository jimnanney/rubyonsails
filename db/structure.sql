CREATE TABLE "accounts" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "oauth_token" varchar(255) NOT NULL, "oauth_uid" varchar(255) NOT NULL, "name" varchar(255) NOT NULL, "email" varchar(255) NOT NULL, "bio" text, "created_at" datetime, "updated_at" datetime, "reviewer" boolean DEFAULT 'f', "admin" boolean DEFAULT 'f');
